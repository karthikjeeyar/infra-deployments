...
oc --kubeconfig ${KCP_KUBECONFIG} apply -f -n spi-system secret generic shared-configuration-file --from-file=config.yaml=$TMP_FILE  -o yaml | oc --kubeconfig ${KCP_KUBECONFIG} apply -f -
rm $TMP_FILE
echo "SPI configured"
